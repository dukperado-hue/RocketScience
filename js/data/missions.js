...
(function (global) {
  ...
  var MISSIONS = [
    ...
    // ---- ERA 3 · V-2 -----------------------------------------------
    {
      ...
      npc: 'narr',
      npc_dialogue: [
        'V-2 หนักร่วมตัน จุดเครื่องแล้วพุ่งขึ้นเกือบตรง เผาเชื้อเพลิงกว่าหนึ่งนาที',
        'ไจโรกับครีบแกรไฟต์จะค่อย ๆ เอียงหัวจรวดหลังพ้น 500 เมตร — เรียกว่า Gravity Turn',
        'ความเร็วที่เคยพุ่งขึ้น จะกลายเป็นความเร็ว "แนวราบ" มันจะไต่ถึงขอบอวกาศ ~55 กม. แล้วทิ้งตัวลงเป้าทะเลไกล ~160 กม. (สเกลลอนดอน→แอนต์เวิร์ป)',
        'เป้าหมาย: ความเร็วสูงสุดเกิน 800 m/s และตกไกลจากฐานเกิน 90 กิโลเมตร'
      ],
      objectives: { maxVelocityMin: 800, downrangeMin: 90000 },
