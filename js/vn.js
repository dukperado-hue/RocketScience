...
(function () {
  ...
  // เนื้อหาบรีฟเฉพาะภารกิจ — โครง 4 ส่วน: (1) บริบท/เป้าหมาย (2) กฎหมาย/ความรับผิด
  const BRIEF = {
    m1_festival: {
      goal: "คืนนี้งานวัดประจำปี ชาวบ้านอยากได้โคมลอยขึ้นฟ้าสวย ๆ — แต่รันเวย์สนามบินอยู่ห่างไม่ถึง 9 กม.",
      law: "พ.ร.บ.การเดินอากาศ: ห้ามปล่อยโคม/พลุในเขตปลอดภัยสนามบิน 9 กม. โคมที่ลอยเข้าเส้นทางบินหรือถูกเครื่องยนต์ดูดเข้าไป = ภัยการบินร้ายแรง มีทั้งโทษอาญาและต้องชดใช้ค่าเสียหาย"
    },
    m2_newyear: {
      goal: "เคาต์ดาวน์ปีใหม่ ฝูงชนรอดูพลุ — จุดให้สูงพอเห็นทั่วลาน แต่อย่ารบกวนน่านฟ้ากลางคืน",
      law: "พ.ร.บ.การเดินอากาศ + ข้อบัญญัติท้องถิ่นเรื่องดอกไม้เพลิง: ต้องแจ้งและจุดในเขตที่กำหนด เศษพลุตกใส่คนดู = ผู้จุดรับผิดทางแพ่งฐานละเมิด"
    },
    m3_rocketfest: {
      goal: "ประเพณีบุญบั้งไฟ งานบุญเดือนหก — ชาวอีสานจุดบั้งไฟขอฝนจากพญาแถนมาแต่ก่อนพุทธกาล กรรมการจับเวลา 'อยู่กลางอากาศนานที่สุด' และวัดความสูง",
      law: "ต้องขออนุญาตนายอำเภอ/ผู้ว่าราชการจังหวัด และผ่านคณะทำงาน Sky Hazard ก่อนจุด; ถ้าบั้งไฟ 'รำดาบ' ตกใส่บ้านหรือไร่นาชาวบ้าน ผู้จุดรับผิดชดใช้ค่าเสียหายเต็มจำนวน (ละเมิด ป.พ.พ. ม.420)"
    },
    m4_talai: {
      goal: "ชิงแชมป์ตะไล บ้านตาลิน หนองบัว — ตะไลของ น้าบุญช่วย มีแสง ไม่ยิงตรง จุดแล้วสะบัดมือขว้างแบบจานบิน ควงเป็นเกลียวสว่านให้สูงและนานที่สุด",
      law: "ขออนุญาตทางจังหวัดเช่นเดียวกับบั้งไฟ; ตะไลที่ปีกไม่ได้สัดส่วนจะร่วงในแนวราบไปไกล ถ้าโดนทรัพย์สินผู้อื่น = รับผิดฐานละเมิด"
    },
    m5_sounding: {
      goal: "ส่งเครื่องมือตรวจอากาศขึ้นชั้นสตราโตสเฟียร์ ~45 กม. เก็บข้อมูลแล้วปล่อยร่มลงมา",
      law: "ต้องขออนุญาต CAAT, ออก NOTAM ปิดห้วงอากาศชั่วคราว และมีเจ้าหน้าที่ความปลอดภัยการยิง (RSO) ประจำจุดปล่อยทุกครั้ง"
    },
    m6_ballistic: {
      goal: "ทดสอบจรวดวิถีโค้ง sub-orbital ให้ถึง ~250 กม. แล้วตกกลับในเขตปลอดภัย",
      law: "ต้องประกาศเขตห้วงอากาศหวงห้าม, ประเมินวงรีจุดตก (impact ellipse) เผื่อความคลาดเคลื่อน 3σ กันพื้นที่ชุมชนออกหมด และต้องได้รับการรับรองด้านความมั่นคงแห่งชาติ"
    },
    m7_orbit: {
      goal: "ส่ง CubeSat เข้าวงโคจรต่ำ (LEO) ที่ 300 กม. — ต้องมี Δv พอถึงความเร็ววงโคจร ~7.73 กม./วิ",
      law: "OST 1967 ข้อ VI: รัฐต้องรับผิดชอบกิจกรรมอวกาศของเอกชนในสังกัด; Liability Convention 1972: รัฐผู้ยิงรับผิดเต็มจำนวนต่อความเสียหายที่เกิดบนพื้นโลก; ต้องจดคลื่นกับ ITU และปฏิบัติตามแนวทางลดขยะอวกาศ"
    },
    m8_geo: {
      goal: "ส่งดาวเทียมสื่อสารดวงใหญ่ขึ้นวงโคจรสูง — เพย์โหลดหนัก payload fraction ต่ำมาก ต้องบริหาร Δv ทุกเมตรต่อวินาที",
      law: "เช่นเดียวกับภารกิจวงโคจร แต่ความรับผิดระหว่างประเทศและวงเงินประกันสูงสุด; ตำแหน่งวงโคจรค้างฟ้าเป็นทรัพยากรจำกัดที่ ITU จัดสรร"
    }
  };

  // (3) ทฤษฎีฉบับเข้าใจง่าย — เลือกตามชนิดจรวด
  const THEORY = {
    khom_loy: "หลักอาร์คิมิดีส: อากาศร้อนเบากว่าอากาศเย็น โคมจึงลอย — แรงยก ≈ (ρเย็น−ρร้อน)·ปริมาตร·g. สรุปง่าย ๆ: โครงเบาที่สุด ไฟแรงพอให้ลอย แต่ห้ามร้อนถึง 233°C ไม่งั้นกระดาษสาติดไฟ",
    phu: "นิวตันข้อ 3: พ่นแก๊สลง ตัวพุ่งขึ้น. ดินขับพลุเผาไหม้เร็วมาก แรงเยอะช่วงสั้น ๆ คุมเพดานยาก. สรุป: เลือกดินขับให้พอดีเป้า อย่าใส่เกิน",
    bangfai: "นิวตันข้อ 3 + สมการจรวด — แต่หัวใจอยู่ที่เสถียรภาพ: 'ศูนย์กด (CP) ต้องอยู่ท้ายศูนย์ถ่วง (CG)' นั่นคือหน้าที่ของหางยาว ๆ. สรุป: เบา + หางสมดุล",
    talai: "โมเมนตัมเชิงมุม (ไจโรสโคปิก): จานที่หมุนเร็วพอจะรักษาแกนตัวเองเหมือนลูกข่าง. สรุป: ปีกได้สัดส่วน 2×รอบวง + สปินให้แรงจากรูประทุเฉียง 15°",
    _tier3: "สมการ Tsiolkovsky: Δv = Isp·g₀·ln(m₀/m_f). ทุกกรัมของมวลเปล่ากิน Δv. สรุป: เบาที่สุด, เชื้อเพลิงพอ, ครีบทำให้ CP อยู่ท้าย CG",
    _tier4: "วิถีกระสุน: องค์ประกอบแนวดิ่งกำหนดเพดาน แนวราบกำหนดระยะ; re-entry ร้อนตาม q̇ ∝ ρ·v³. สรุป: เล็งมุม+Δv พอดี อย่าพุ่งเกิน",
    _tier5: "Δv = Isp·g₀·ln(m₀/m_f) ต้องแตะ ~7.73 กม./วิ + gravity loss อีกเป็นพัน. สรุป: staging ทิ้งมวลเปล่า, Isp สูงที่ท่อนบน, เพย์โหลดเบาเท่าที่ทำได้"
  };

  function theoryFor(rocket) {
    if (!rocket) return THEORY._tier3;
    if (THEORY[rocket.id]) return THEORY[rocket.id];
    const n = window.TIERS && window.TIERS[rocket.tierKey] ? window.TIERS[rocket.tierKey].n : 2;
    return THEORY["_tier" + Math.max(3, n)] || THEORY._tier3;
  }

  // บรีฟ 4 ส่วน — ยิงตอนเข้าโรงประกอบ (VAB), จรวดถูกเลือกแล้ว
  function brief(run, opts) {
    ...
    const targets = `เป้าหมายความสูง ${tgtU}` +
      (m.timeAloftTarget ? ` · จับเวลาอยู่ฟ้าให้ถึง ${m.timeAloftTarget} วิ` : "") +
      (m.targetOrbit ? ` · ความเร็ววงโคจร ~${(m.targetOrbit / 1000).toFixed(2)} กม./วิ` : "") +
      ` · งบ ${m.budget.toLocaleString("en-US")} ฿`;

    const lines = [
      { who: "pchang", text: `📋 พี่ช่าง (Mission CAPCOM) — บรีฟภารกิจ “${m.titleTh}”` },
      { who: "pchang", text: `1️⃣ บริบท & เป้าหมาย: ${b.goal || m.briefTh}` },
      { who: "pchang", text: `   ${targets}` },
      { who: "pchang", text: `2️⃣ กฎหมาย & ความรับผิด: ${b.law || "ทำเอกสารขออนุญาตให้ครบก่อนจุด — ปล่อยโดยไม่มีใบอนุญาตถือเป็นลักลอบปล่อย มีบทลงโทษ"}` },
      { who: "pchang", text: `3️⃣ ทฤษฎี (ฉบับเข้าใจง่าย): ${theoryFor(r)}` },
      { who: "pchang", text: `4️⃣ ความปลอดภัย & อากาศ — METAR: ${metarLine(run)}` }
    ];
    ...
    if (w.type === "thunderstorm")
      ...
      lines.push({ who: "kaitun", text: "จดครบแล้วค่ะพี่ช่าง! เริ่มประกอบเลยไหมคะ" });
    lines.push({ who: "samlee", text: pick([
      "อากาศเป็นเรื่องของคนขี้กลัว ประกอบได้แล้ว",
      "ทฤษฎีฟังพอเป็นพิธี ฉันอยากเห็นมันขึ้น (หรือระเบิด)",
      "บรีฟยาวไป — ลงมือเลย กะปิเตรียมของ"
    ]) });
    lines.push({ who: "pchang", text: "พี่ช่างจะอยู่ในไลน์ตลอดภารกิจ ลงมือประกอบได้เลย" });
  ...
  function atVab(rocket) {
    ...
    if (rocket && rocket.id === "bangfai") {
      play([
        { who: "kaitun", text: "บั้งไฟ! อันนี้หนูเคยเห็นในงานบุญ เสียงดังมากเลยค่ะ เอ๊ะ ทำไมต้องใส่ดินตั้ง 3 ชั้นด้วยล่ะคะ?" },
        { who: "pchang", text: "เพราะดินแต่ละชั้นทำงานคนละหน้าที่ ไข่ตุ๋น — ดินลำตัวคือแรงขับหลัก อัตราส่วนดินประสิว 1 กก. ต่อถ่านป่นละเอียด 2.3–2.5 ส่วน พรมน้ำไล่ความไว; ดินคอเป็นตัวเชื่อม 1:1 ดินใหม่กับดินเก่า เผาปานกลาง; ดินหัวเผาช้าที่สุด เป็น 'ดินเลี้ยง' ให้บั้งไฟค้างฟ้านาน กรรมการจับเวลาตรงนั้น" },
        { who: "pchang", text: "แล้วต้องอัดดินด้วยแม่แรงให้อยู่ 300–400 PSI — หลวมไปเม็ดดินพรุนเผาลามไม่คุมทิศ แน่นไปไฟจุดไม่ทะลุแกน; จากนั้นเจาะรูแกนเหล็กเป็นทรงกรวย ยอด 4 ไฟกิน 14 ตูด 20 เฟื่อง 25 มม. รูนี้แหละคือกราฟแรงขับ ตูดกว้าง = ออกตัวแรง เฟื่องคือคอคอด ถ้าแคบไปความดันพุ่ง CATO" },
        { who: "pchang", text: "สุดท้ายคือหาง — หางบั้งไฟยาว ~290 ซม. คือครีบยักษ์ที่ดึง CP ไปท้ายสุด มัดเข้าบั้ง ~37 ซม. แล้วถ่วงเสมอให้สมดุลที่ปลายนิ้ว ถ้าหางเพี้ยนบั้งไฟจะ 'รำดาบ' — ส่ายเป็นเกลียวแล้วร่วง เหมือนจรวดที่ CG หลัง CP" },
        { who: "samlee", text: "หรืออัดดินให้แน่นสุด เจาะรูให้แคบสุด แล้วดูว่ามันจะขึ้นหรือจะระเบิด กะปิ นายจุด" },
        { who: "kapi", text: "กะปิถอยจากแท่นสองก้าว มือถือชนวนยาวเป็นพิเศษ" }
      ], {});
      return;
    }
    const intro = {
  ...
  function atReport(sum, run) {
    ...
    } else if (fr === "BANGFAI_CATO") {
      lines.push({ who: "kaitun", text: "เอ๊ะ! ลำบั้งไฟระเบิดคาแท่นเลยค่ะ!" });
      lines.push({ who: "pchang", text: "CATO — ความดันในห้องเผาไหม้เกินกำลังปลอกลำ สาเหตุมีไม่กี่อย่าง: เฟื่อง (คอคอด) แคบเกินจนดัชนีความดันเกินพิกัด, ดินร้อนเกิน (ถ่านน้อยกว่า 2.3 ส่วน), อัดหลวมกว่า 300 PSI จนเม็ดดินแตกร้าว, หรือรูแกนไม่เรียงจากแคบไปกว้าง เลือกแก้ทีละอย่าง" });
      lines.push({ who: "samlee", text: "กะปิยังอยู่ไหม... ยกมือให้ดูหน่อย" });
      lines.push({ who: "kapi", text: "กะปิโผล่จากควัน หน้าดำเป็นเขม่า ยกนิ้วโป้งให้อย่างเหนื่อยหน่าย" });
    } else if (fr === "BANGFAI_WOBBLE") {
      lines.push({ who: "kaitun", text: "มันไม่พุ่งตรงเลยค่ะ ส่ายเป็นเกลียวแล้วก็หัวทิ่มลงมา!" });
      lines.push({ who: "pchang", text: "นั่นแหละที่ช่างบั้งไฟเรียกว่า 'รำดาบ' — หางไม่สมดุล ศูนย์กด (CP) ไม่ได้อยู่ท้ายพอ พอ CG ค่อนไปข้างหน้าน้อยกว่าที่ควร โมเมนต์คืนตัวไม่พอ มันเลยควงสะสมจนเสียแกน หางต้อง ~290 ซม. มัดเข้าบั้ง ~37 ซม. แล้วถ่วงเสมอให้สมดุลที่ปลายนิ้วเป๊ะ" });
      lines.push({ who: "pchang", text: "ถ้ามัดเข้าบั้งสั้นกว่า 24 ซม. รอยต่อจะสะบัด หางเกือบหลุด — อันนั้นยิ่งหนัก ต้มหางช่วยลดน้ำหนักท้ายได้ แต่ต้องปรับถ่วงเสมอตามด้วย" });
      lines.push({ who: "kapi", text: "กะปิเอาเชือกทาบวัดหางที่หักคาดิน แล้วส่ายหัวช้า ๆ" });
