...
const ROCKETS = [
  ...
  // ---------- Tier 2 ----------
  {
    ...
    bangfai: true,        // Master Craftsman: ดินขับ 3 ชั้น + แรงอัด PSI + เจาะรูแกน + จูนหาง (js/bangfai.js)
    blurb: "จรวดดินปืนอัดลำไม้ไผ่/ท่อ PVC ภูมิปัญญาช่างบั้งไฟอีสาน — ดินขับ 3 ชั้น (หัว/คอ/ลำตัว) อัดด้วยแม่แรง เจาะรูแกนเป็นทรงกรวย แล้วจูนหางยาวให้สมดุลไม่ให้ 'รำดาบ'"
  },
  {
